...
\[
\forall n,n',W,\start, \addrend, \perm \ldotp \execCond{n,W,\start,\addrend,\perm} \land n' \leq n \Rightarrow \execCond{n',W,\start,\addrend,\perm}
\]
\end{lemma}

\begin{lemma}[Entry condition uniformity]
\[
\forall n,n',W,\start, \addrend, \addr \ldotp \entryCond{n,W,\start,\addrend} \land n' \leq n \Rightarrow \entryCond{n',W,\start,\addrend,\addr}
\]
\end{lemma}
