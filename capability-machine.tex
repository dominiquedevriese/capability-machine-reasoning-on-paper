...
To define the value relation, we use a standard heap invariant that ensures all values in the region are in the value relation. The following region uses pairs of natural numbers, $(\var{base},\var{end})$, as states, so pairs of natural numbers are in the set $\States$.
\[
