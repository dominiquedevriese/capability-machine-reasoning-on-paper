...
if
  \[
    (\reg_0\update{\pcreg}{c_{\adv}}
          \update{r_1}{c_g},\hs_{\adv} \uplus \hs_{\flag} \uplus \hs_{g} \uplus h_f) \step[n] (\halted,h')
  \]
where 
\begin{align*}
  ...
  &\heapSat[\hs_{\adv}]{n}{\iota^{\var{nwl}}_{\start_\adv,\addrend_\adv}}
\end{align*}
and $hs_\flag(\flag) = 0$ and $hs_g$ contains the code of $g$ including a $\readwrite$-capability for $\hs_\flag$, 
then
\[
  h'(\flag) = 0
\]
...
\begin{lemma}
  ...
  \item $W \futurestr \wrev{W} \Rightarrow W \futurewk \wrev{W}$
  \end{itemize}
