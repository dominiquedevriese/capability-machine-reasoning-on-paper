...
\begin{align*}
 ...
 \sem{\move{\refreg{r_1}}{\rv}}            & = \begin{cases}
                                                 \stdUpdatePc{\updateReg{r_1}{\memreg(\rv)}} & \\ % For now we do this, so you need to use a jump to move stuff into pc.
                                                 \failed   & \text{otherwise }
                                 \end{cases}
\\
...
\begin{specification}[Malloc v.2]
  \begin{align*}
    ...
    &\qquad\Rightarrow \\
    &\qquad \quad\exists \Phi' \in \Mems \ldotp \exists \hsfoot', \hsframe' \in \HeapSegments\ldotp\\
...
\end{align*}
\end{specification}
\lau{I am not satisfied with the pc in the premise.}
