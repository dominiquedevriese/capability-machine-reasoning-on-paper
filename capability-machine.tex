...
\]
\begin{align*}
  \iota_{\var{start},\var{end}}(W) & \defeq (s,=,H_{\var{std}}) \\
  H_{\var{std}}\; s\; W & \defeq \{\npair{\hs} \mid \forall \addr \in [\var{base},\var{end}] \ldotp \hs(a) \in \stdvr(\roll \; W)\}
\end{align*}
