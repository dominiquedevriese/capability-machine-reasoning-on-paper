...
\]
Using the ordering where $\revoked \future \temp$ and $\future$ is otherwise reflexive, and a family of equivalences where everything is equal at 0 and othervise the equivalences are ``normal'' equality. We claim this is a preordered \cofe{}. %TODO prove this claim! And show the new "region" is a preordered cofe with the claimed ordering.
