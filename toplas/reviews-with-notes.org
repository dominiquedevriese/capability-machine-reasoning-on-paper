...
* TODO Have a look at this point again.
...
* TODO Any property from a high-level language is of interest. Address hiding for one. Not sure whether we should include a list of arbitrary things 
