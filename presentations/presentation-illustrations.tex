...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=.5, every node={scale=.5}]
    ...
    \begin{scope}
      \clip (-.1,-.1) rectangle (6.1,15);
      \draw<.>[fill=white] (0,4) rectangle (6,15.1);
    \end{scope}
    \draw<.> [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
    (6.5,2.5) -- (6.5,16) node[draw=black] (sp1) [black,midway,xshift=0.8cm] {};
    \draw<.> node[right=0cm of sp1] { stack pointer };
    ...
    \begin{scope}
      \clip (-.1,-.1) rectangle (6.1,15);
      \draw<.>[fill=white] (0,7) rectangle (6,15.1);
    \end{scope}
    ...
    \begin{scope}
      \clip (-.1,-.1) rectangle (6.1,15);
      \draw<.>[fill=white] (0,9) rectangle (6,15.1);
    \end{scope}
    \draw<.> [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
      (10.5,4) -- (10.5,16) node[draw=black] (spold) [black,midway,xshift=0.8cm] {};
    \draw<.> [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
    ...
    \begin{scope}
      \clip (-.1,-.1) rectangle (6.1,15);
      \draw<.>[fill=white] (0,12) rectangle (6,15.1);
    \end{scope}
...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=.5, every node={scale=.5}]
    ...
    \draw<.>[green,thick] (13,7.5) -- (19,9);
    \draw<.>[green,very thick] (19,7.5) -- (13,9);
    \draw node[green,cloud,cloud puffs=10.8,cloud puff arc=110, aspect=3, draw] () at (14,4) {Stack pointer is local!};
