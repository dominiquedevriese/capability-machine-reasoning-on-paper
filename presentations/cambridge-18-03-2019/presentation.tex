...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=.45, every node={scale=.5}]
    ...
    \end{onlyenv}
    \draw<+-+(2)>[fill=gray!50] (0,6) rectangle node {\tiny old return cap code} (6,6.5);
    \begin{onlyenv}<+->
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{.6\textwidth}
      \begin{tikzpicture}[scale=.45, every node={scale=.5}]
        ...
        \draw (-0.5,0.25) node[align=right] { \scriptsize 0 };
        \draw (-0.5,4.25) node[align=right] { \scriptsize 8 };
        \draw (-0.5,8.25) node[align=right] { \scriptsize 16 };
        \draw (-0.5,12.25) node[align=right] { \scriptsize 24 };
  ...
  \draw (6.5,14.325) node[anchor=west, align=left] {Memory}; \draw[->] (-1.5,0) -- (-1.5,4.5);

  % Mem data
  \draw<1-> (3,0.75) node { \scriptsize 42 };
  \draw<1-> (3,1.25) node { \scriptsize 2 };
  \draw<1-> (3,1.75) node { \scriptsize 14 };
  \draw<1-> (3,2.75) node { \scriptsize 10 };
  \draw<1-> (3,2.25) node { \scriptsize 19 };
  \draw<1-> (3,3.75) node { \scriptsize 0 };
  \draw<1-> (3,3.25) node { \scriptsize 0 };
  \draw<1-> (3,4.25) node { \scriptsize 0 };
  \draw<1-> (3,4.75) node { \scriptsize 0 };
  \draw<1-> (3,5.75) node { \scriptsize 3 };
  \draw<1-> (3,6.25) node { \scriptsize 20 };
  \draw<1-> (3,6.75) node { \scriptsize 21 };
  \draw<1-> (3,7.25) node { \scriptsize 11 };
  \draw<1-> (3,7.75) node { \scriptsize 10 };
  \draw<1-> (3,8.25) node { \scriptsize 15 };
  \draw<1-> (3,8.75) node { \scriptsize 19 };
  \draw<1-> (3,9.25) node { \scriptsize 29 };
  \draw<1-> (3,9.75) node { \scriptsize 0 };
  \draw<1-> (3,10.25) node { \scriptsize 0 };
  \draw<1-> (3,10.75) node { \scriptsize 0 };
  \draw<1-> (3,11.25) node { \scriptsize 0 };
  \draw<1-> (3,11.75) node { \scriptsize 0 };
  \draw<1-> (3,12.75) node { \scriptsize 0 };
  \draw<1-> (3,13.25) node { \scriptsize 0 };
  \draw<1-> (3,13.75) node { \scriptsize 64 };
  \draw<1-> (3,14.25) node { \scriptsize 5 };
  % Reg data
  \draw<1-> (12.75,10.75) node { \scriptsize 8 };
  \draw<1-> (12.75,7.75) node { \scriptsize 24 };
  \draw<1-> (12.75,6.25) node { \scriptsize 16 };
  \draw<1-> (12.75,4.75) node { \scriptsize 2 };

  % Mem pointers
  \draw<1> (3,12.25) node { \scriptsize 16 };
  \draw<1> (3,5.25) node { \scriptsize 9 };
  \draw<1> (3,0.25) node { \scriptsize 8 };
  % Reg pointers
  \draw<1> (12.75,9.25) node { \scriptsize 0 };

  % Mem pointers HL
  \draw<2> (3,12.25) node { \color{red} \scriptsize 16 };
  \draw<2> (3,5.25) node { \color{red} \scriptsize 11 };
  \draw<2> (3,0.25) node { \color{red} \scriptsize 8 };
  % Reg pointers HL
  \draw<2> (12.75,9.25) node { \color{red} \scriptsize 0 };

  \draw<3> (12.75,9.25) node { };
  ...
  % Reg pointers HL
  \draw<4->[capa] (12.75,9.25) edge[postaction={decorate}] (12.0,9.25);
  \draw<4> (12.0,9.25) edge[-latex,in=0,out=180] (6.1,0.25);
  ...
  \draw<5> (12.0,9.25) edge[-latex,in=0,out=180] (6.3,0.355);
  ...
  \draw<6-> (12.0,9.25) edge[-latex,in=0,out=180] node[right] {\scriptsize \textsc{rx}} (6.3,0.355);
\end{tikzpicture}
\end{column}
