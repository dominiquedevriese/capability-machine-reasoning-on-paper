...
first with a capability for the closure creator \texttt{\footnotesize{g1}}. Consequently, we need
...
adversary is again allowed to rely on its old local state so we
...
(just like we do) so they can store and recover their old stack pointer after
