...
part: \texttt{g1} creates a closure with one variable $x$ in its
environment and \texttt{f4} as the code. When the closure is called,
it expects to be called with a capability for a callback and a stack
capability. 
