...
returning to the adversary after he/she invoked our code. In this case, we will
...
pointer in a global data structure, he/she can store return pointers on the
...
a capability that he/she can jump to but not read from, i.e. an enter
...
pointer, he/she cannot get hold of the contents of the data structure, but after
...
$\exec$ capability if he/she is not worried about that. However, there is one
scenario that we need to prevent, namely that he/she constructs the callback
capability to point into the stack, where he/she may have stored local
...
presentation purposes, we omit some details in the lemmas we state. 
