...
standard C ABI\lau{This sentence does not compute}. However, to prevent various ways of misusing this basic scheme,
...
to it in circumstances where this should not be possible: for example, he may
