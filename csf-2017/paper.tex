...
trusted call and return instructions, and disjoint, per-component
...
next. After that, we define a number of reusable macro-instructions that
...
more. The technical appendix~\cite{technical_appendix} contains detailed descriptions
of all the macros.
