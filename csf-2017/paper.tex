...
Cap-mach:
\begin{itemize}
\item \cite{Watson2015Cheri} CHERI papers
\item \cite{akram_el-korashy_formal_2016}
\end{itemize}

Logical relation:
\begin{itemize}
\item \cite{Hur:2011:KLR:1926385.1926402}
\item \cite{Dreyer:jfp12}
\item \cite{Devriese:2016ObjCap}
\item \cite{osvald_gentrification_2016}
\end{itemize}
