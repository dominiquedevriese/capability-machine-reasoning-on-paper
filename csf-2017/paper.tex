...
need to check (1) the stack pointer that the closure receives from the
adversary (it must have the correct permission and fit with our calling
convention) and (2) the adversary callback is global.
...
>>>>>>> e3d523ceea577652d092fc6ddf967a9ae7773289
permanent.
...
=======
In this section, we summarize how our work relates to previous work. We do not
