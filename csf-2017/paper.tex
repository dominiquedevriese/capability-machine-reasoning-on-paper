...
might contain old stack pointers or return pointers. If not, it could break the
...
adversary is again allowed to rely on its old local state which means we
...
explicit and useful way to formalize well-bracketed control flow. The idea would
