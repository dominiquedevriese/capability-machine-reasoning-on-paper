...
discipline. \texttt{\footnotesize{scall $r$($\overline{r_{\var{args}}}$,$\overline{r_{\var{priv}}}$)}} Jumps
...
\texttt{\footnotesize{scall}} to call the untrusted code. On the other hand, \texttt{\footnotesize{f2}} uses
...
two example programs \texttt{\footnotesize{f3}} in \figurename~\ref{fig:prog-f3} and
\texttt{\footnotesize{g1}} in \figurename~\ref{fig:prog-g1}.
...
like the well-bracketedness that Example~\texttt{\footnotesize{g1}} relies on.\footnote{It is a
