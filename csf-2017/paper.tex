...
\begin{figure}[htbp]
  ...
  & \left\{
    ...
    \end{multlined}
     \; \middle| \;
    \begin{aligned}
      & \forall n' < n, W' \future W \ldotp \forall a \in [\start,\addrend], \perm \in \var{perms} \ldotp \\
...
\[
    ...
    m &  \multicolumn{3}{@{}l}{\;\defeq \ms_{f1} \uplus \ms_\flag \uplus \ms_{\var{link}} \uplus \hs_\adv \uplus} \\
      & \multicolumn{3}{@{}l}{\phantom{\;\defeq \;} \ms_{\malloc} \uplus \ms_{\var{stk}} \uplus \ms_{\var{frame}}} \\
    \end{array}
\]
