...
configurations are for execution by the adversary, i.e. without the risk that
they will be able to use it to break protocols in the world. The definition of
the logical relation is found in \figurename{}s~\ref{fig:logrel}
