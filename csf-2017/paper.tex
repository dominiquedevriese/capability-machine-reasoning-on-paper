...
\texttt{\footnotesize{f4}} as the program (note that we here use knowledge about the stack usage to make optimizations to the calling convention). \texttt{\footnotesize{f4}} expects one argument, a callback. The
