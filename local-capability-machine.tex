...
\end{verbatim}
              ...
              \begin{proof}[Proof of Lemma~\ref{lem:correctness-f1}]
                ...
                \item $\npair{(\start_{\adv},\addrend_{\adv})} \in \readCond{}(\glob)(W)$
                  \begin{itemize}
                  \item Show: $\iota^{\nwl,p}_{\start_\adv,\addrend_\adv} \nsubsim[n-1] \iota^\pwl_{\start_\adv,\addrend_\adv}$. %Lemma
                  \end{itemize}
                \end{itemize}
                Have
                \begin{enumerate}[resume]
...
\begin{proof}[Proof of Lemma~\ref{lem:iotax-is-a-region}]
  \begin{itemize}
  \item $\phi_\pub$ is defined as the reflexive transitive closure, so it is immediately well foremd.
...
\begin{proof}[Proof of Lemma~\ref{lem:hnwl-mono-str}]
  ...
  \end{enumproof}
  \ref{pf:hnwl-mono:ob1} follows trivially from \label{pf:hnwl-mono:ass}. \ref{pf:hnwl-mono:ob1} follows from Assumption~\ref{pf:hpwl-mono:ass}, \ref{pf:hnwl-mono:ob1} (which we just argued), $W' \futurestr W$, and Lemma~\ref{lem:stdvr-non-loc-priv-mono}.
\end{proof}
...
\begin{proof}[Proof of Lemma~\ref{lem:stdvr-non-loc-priv-mono}]
  If $w = \stdcap[(\perm,\glob)]$, then iet follows from Lemma~\ref{lem:stdvr-glob-priv-mono}.
