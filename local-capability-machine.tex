...
\subsection{Lemmas}
\begin{lemma}[Scall works]
  
  If
  \begin{itemize}
  \item $\heapSat[\ms]{n}{W}$ 
  \item $c_{\mathit{pc}} = \reg(\pcreg)$
  \item $c_{\mathit{pc}} = ((p,g),b,e,a)$ and
  \item $\ms(a,a+k) = \mathtt{scall}(r,\overline{r_{\mathit{arg}}},  \overline{r_{\mathit{priv}}})$
  \end{itemize}
