...
\begin{proof}[Proof of Lemma~\ref{lem:wk-nequal-and-future}]
  ...
  \[
    W_2(r) =
    \begin{cases}
      \revoked & \text{ if $r \in \dom(W_2)$ and $W_1'(r) = \revoked$} \\
      (v_1',s_1',\phi_{\pub2},\phi_2,H_2) & \text{ if $r \in \dom(W_2)$ and $W_1'(r) = (v_1',s_1',\_,\_,\_)$ and $W_2(r) = (\_,\_,\phi_{\pub2},\phi_2,H_2)$}\\
      W_1'(r) & \text{ otherwise}
    \end{cases}
  \]
