...
\begin{enumproof}
  ...
  \item Hyp-Callee\\
    Assume
    \begin{itemize}
    \item $\ms_\stk |_{\start_stk+1,\addrend_\stk} = \ms_{\mathit{act}} \uplus \ms_{\mathit{unused}}$
    ...
    \end{itemize}
    where $\ms_{\mathit{act}}$ is the on stack activation code for this $\mathtt{scall}$.
  \item Hyp-Cont\\
    % TODO
\end{enumproof}
