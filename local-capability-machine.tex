...
\cline{2-2}
   & 0 \\
\cline{2-2}
$r_{\var{stk}} \rightarrow$   & local stack\\
   & $\vdots$
\end{tabular}
\hspace{0.5cm}
\begin{tabular}{*{10}{>{\centering\arraybackslash}p{0.2cm}}}
  \begin{sideways}
    $\pcreg$
  \end{sideways}
& 
...
&\\
\hline
\multicolumn{1}{|>{\centering\arraybackslash}p{0.2cm}}{
$\pc$
} &
\multicolumn{1}{|>{\centering\arraybackslash}p{0.2cm}}{
$c_s$
