...
\begin{align*}
  ...
  &\heapSat[\hs_{\malloc}]{n}{[0 \mapsto \iota_{\malloc}]}
\end{align*}
and $hs_\flag(\flag) = 0$. $hs_g$ contains the code of $g$ including a $\readwrite$-capability for $\hs_\flag$. $\hs_\adv$ is only instructions.
then
\[
  h'(\flag) = 0
\]  
