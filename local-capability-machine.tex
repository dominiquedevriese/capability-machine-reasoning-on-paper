...
\begin{align*}
  ...
  &\iota_{\start,\addrend}^\pwl \defeq \lambda v \ldotp
    \begin{cases}
      (v,1,=,H^\pwl (\start,\addrend)) & v \neq \revoked \\
      \bot & \text{otherwise}
    \end{cases}
  &H^{\var{pwl}} : \Addrs^2 \fun \States \fun (\Worwk \monnefun \UPred{\HeapSegments})\\
  &H^{\var{pwl}} (\start,\addrend)\; s \; \hat{W} \defeq \left\{\npair{\hs} \middle|
    \begin{aligned}
...
\begin{align*}
  ...
  &\iota_{\start,\addrend}^{\var{nwl}} \defeq \lambda v \ldotp
    \begin{cases}
      (v,1,=,H^{\var{nwl}} (start,\addrend)) & v \neq \revoked \\
      \bot & \text{otherwise}
\end{cases}
\\ \\
  &H^{\var{nwl}} : \Addrs^2 \fun \States \fun (\Worstr \monnefun \UPred{\HeapSegments})\\
