      ...
      \item \label{item:proof-cont} At this point, we apply the \texttt{scall} lemma, to get
        ...
        \begin{enumproof}
          ...
          \item Hyp-Cont\\
            ...
            \]
            Use Lemma~\ref{lem:anti-red-obs}. Let $\ms_f$ be given, then
            \[
              (\reg_8,\ms_7 \uplus \ms_r \uplus \emptyset \uplus \ms_\unused^{(5)}) \step[l] (reg_9,\ms_7 \uplus \ms_r \uplus \emptyset \uplus \ms_0)
            \]
            where
            \begin{itemize}
            ...
            \begin{enumproof}
            \item $W_{10} \futurewk W_3$\\
              We have
              \[
                \forall r \in \dom(W_3) \ldotp W_3 = W_{10}
              \]
              if the region is permanent, then it is there because $W_{10} \futurestr W_3$. If it is temporary, then it is there because it was just reinstated.
            ...
            \item $\memSat[n_6-l]{\ms_7 \uplus \ms_r \uplus \emptyset \uplus \ms_0}{W_{10}}$
            \item $\npair[n_6-l]{\reg_9} \in \stdrr(W_{10})$
            \end{enumproof}
...
\begin{lemma}[$\mathtt{scall}$ works]
  ...
  \item[Hyp-Cont] If
    \begin{itemize}
    \item $n' \leq n-2$
    \item $W'' \futurewk \revokeTemp{W}[\iota^{\sta}(\temp,\ms_\stk\uplus \ms_\act)][\iota^\sta(\temp,\ms_{\mathit{unused}}'')][\iota^\sta(\temp,\ms_f)]$
    \item $\memSat[n']{\ms''}{\revokeTemp{W''}}$ 
    \item for all $r$, we have that:
      \begin{equation*}
        \reg'(r)
