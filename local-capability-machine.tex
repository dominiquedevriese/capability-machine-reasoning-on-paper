...
\[  
  ...
  \begin{aligned}
    ...
    &\qquad \quad \forall \iota_\malloc \futurewk \iota_{\malloc,0} \land \\
    &\qquad \quad \memheap = m_{\var{footprint}} \uplus \hsframe \land\\
    &\qquad \quad \heapSat[m_{\var{footprint}}]{n}{[i \mapsto \iota_\malloc]} \land \\
    ...
    &\qquad \qquad \qquad  \iota_{\malloc}' \futurewk \iota_{\malloc}\\
    &\qquad \qquad \qquad \heapSat[m_{\var{footprint}}']{n-j}{[i \mapsto \iota_{\malloc}']} \land \\
