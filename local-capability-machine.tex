...
\end{align*}
and $hs_\flag(\flag) = 0$. $hs_{f1}$ contains the code of $f1$ \dominique{do you mean f1?} including a $\readwrite$-capability for $\hs_\flag$. $\hs_\adv$ is only instructions.
then
\[
  h'(\flag) = 0
\]  
