...
\end{lemma}
\begin{proof}[Proof of Lemma~\ref{iotapwl-is-a-region}]
  % TODO
\end{proof}
...
\end{lemma}
\begin{proof}[Proof of Lemma~\ref{iotanwl-is-a-region}]
  % TODO
\end{proof}
...
\end{lemma}
\begin{proof}[Proof of Lemma~\ref{iotanwlp-is-a-region}]
  % TODO
\end{proof}
...
\end{lemma}
\begin{proof}[Proof of Lemma~\ref{iotansta-is-a-region}]
  % TODO
\end{proof}
...
\end{lemma}
\begin{proof}[Proof of Lemma~\ref{iotanstau-is-a-region}]
  % TODO
\end{proof}
...
\begin{proof}
  ...
  \item $\exists H,s \ldotp$ $W(r) = (\_,s,\_,\_,H)$
    ...
    \dominique{TODO: fix what follows for the recent step-related changes...}
