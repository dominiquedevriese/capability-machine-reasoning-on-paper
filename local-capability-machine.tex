...
\lau{It would maybe make sense to clear the stack before calls rather than after. \emph{We} do after all not care what is on there, but we want to make sure that it is not used by an adversary to make an unintended information flow. }
