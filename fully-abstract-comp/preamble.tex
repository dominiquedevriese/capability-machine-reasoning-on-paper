...
\newcommand\nsupsim{\mathrel{\ooalign{\raise.2ex\hbox{$\subset$}\cr
      \hidewidth\lower.8ex\hbox{\scalebox{0.9}{$\sim$}}\hidewidth\cr}}}
\newcommand\nsubsim{\mathrel{\ooalign{\raise.2ex\hbox{$\supset$}\cr
      \hidewidth\lower.8ex\hbox{\scalebox{0.9}{$\sim$}}\hidewidth\cr}}}
...
\newcommand{\lre}[1][\square,\gc]{\lreg[#1]{\untrusted}}
\newcommand{\lretrusted}[1][\square,\gc]{\lreg[#1]{\trusted}}
\newcommand{\lrexjg}[2][\square,\gc]{\typesetlr{E}^{#1}_{\mathrm{xjmp},#2}}
\newcommand{\lrexj}[1][\square,\gc]{\lrexjg[#1]{\untrusted}}
\newcommand{\lrexjtrusted}[1][\square,\gc]{\lrexjg[#1]{\trusted}}
