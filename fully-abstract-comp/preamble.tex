...
\newcommand{\lrp}[1][\square,\gc]{\typesetlr{P}^{#1}}
...
\newcommand{\execCond}[2][\gc]{\plainfun{executeCondition_{#1}}{#2}}
...
\newcommand{\readCond}[2][\gc]{\plainfun{readCondition_{#1}}{#2}}
\newcommand{\stackReadCond}[2][\gc]{\plainfun{stackReadCondition_{#1}}{#2}}
\newcommand{\xReadCond}[2][\gc]{\plainfun{readXCondition_{#1}}{#2}}
\newcommand{\writeCond}[2][\gc]{\plainfun{writeCondition_{#1}}{#2}}
\newcommand{\stackWriteCond}[2][\gc]{\plainfun{stackWriteCondition_{#1}}{#2}}
