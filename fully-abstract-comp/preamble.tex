...
\newcommand{\lretrusted}[1][\square]{\typesetlr{E}^{#1}_{\var{trusted}}}
\newcommand{\lrexj}[1][\square]{\typesetlr{E}^{#1}_{\var{xjmp}}}
\newcommand{\lrk}[1][\square]{\typesetlr{K}^{#1}}
\newcommand{\lrrg}[2][\square]{\typesetlr{R}_{#1}^{#2}}
\newcommand{\lrr}[1][\square]{\lrrg{\untrusted}{#1}}
\newcommand{\lrrtrusted}[1][\square]{\lrrg{\trusted}{#1}}
\newcommand{\lro}[1][\square]{\typesetlr{O}^{#1}}
\newcommand{\lrol}{\lro[\preceq]}
\newcommand{\lror}{\lro[\succeq]}
\newcommand{\lrvg}[2][\square]{\typesetlr{V}^{#2}_{#1}}
\newcommand{\lrv}[1][\square]{\lrvg{\untrusted}{#1}}
\newcommand{\lrvtrusted}[1][\square]{\lrvg{\trusted}{#1}}
...
\newcommand{\retoffset}{\constant{ret\_ptr\_offset}}
%%% Named registers
