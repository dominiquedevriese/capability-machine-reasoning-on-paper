...
\newcommand{\lre}[1][\square,\gc]{\typesetlr{E}^{#1}}
\newcommand{\lretrusted}[1][\square,\gc]{\lreg[#1]{\trusted}}
\newcommand{\lrexj}[1][\square,\gc]{\typesetlr{E}^{#1}_{\mathrm{xjmp}}}
\newcommand{\lrk}[1][\square,\gc]{\typesetlr{K}^{#1}}
\newcommand{\lrrg}[2][\square,\gc]{\typesetlr{R}^{#1}_{#2}}
\newcommand{\lrr}[1][\square,\gc]{\lrrg[#1]{\untrusted}}
\newcommand{\lrrtrusted}[1][\square,\gc]{\lrrg[#1]{\trusted}}
\newcommand{\lro}[1][\square,\gc]{\typesetlr{O}^{#1}}
\newcommand{\lrol}{\lro[\preceq,(\ta,\stkb,\gsigrets,\gsigcloss)]}
\newcommand{\lror}{\lro[\succeq,(\ta,\stkb,\gsigrets,\gsigcloss)]}
\newcommand{\lrvg}[2][\square,\gc]{\typesetlr{V}^{#1}_{#2}}
...
\newcommand{\lrcomp}[1][\square,\gc]{\typesetlr{C}^{#1}}
\newcommand{\lrec}[1][\square,\gc]{\typesetlr{EC}^{#1}}
\newcommand{\lrheap}[1][]{\typesetlr{H}^{#1}}
