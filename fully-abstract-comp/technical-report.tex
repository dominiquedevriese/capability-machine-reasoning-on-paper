...
\[
  ...
  \left\{
    \begin{array}{l}
      ...
      \quad \forall j < i \ldotp \forall a_i \in \dom(\ms_i) \ldotp \forall a_j \in \dom(\ms_j) \ldotp a_i < a_j) \wedge\\
...
%
    ...
    \begin{array}{l}
      ...
      \quad (\isLinear{\vsc_1} \Rightarrow \forall W' \future W, W_o, n' < n, \stpair[.]{\vsc_S'}{\vsc'_T} \in H_\sigma \; \sigma \; W_o \ldotp \\
      \qquad \npair[n']{\src{\vsc_S},\src{\vsc_S'},\vsc_T,\vsc_T'} \in \lrexj(W'\oplus W_o)) \wedge \\
      \quad (\nonLinear{\vsc_1} \Rightarrow \forall W' \future \purePart{W}, W_o, n' < n, \stpair[.]{\vsc_S'}{\vsc'_T} \in H_\sigma \; \sigma \; W_o \ldotp \\
...
\left. \npair{\arraycolsep=0pt\left(\array{l}\retptrd(\baddr,\eaddr),\\((\rw,\linear),\baddr,\eaddr,\aaddr)\endarray\right)} \middle| \right. \\
      \\
      \begin{array}{l}
        \exists r \in \dom(\pwpriv[\xi(\hat{W})]) \ldotp \pwpriv[\xi(\hat{W})](r) \nequal (\stareg[(\ms,\ms)]{\spa}, ((\rx,\linear),\baddr',\eaddr',\aaddr'+\calllen)) \tand \\
