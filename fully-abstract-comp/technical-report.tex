...
\[
  \lre(W) = \left\{ \npair{\stpair{v}{v}} \middle| 
    \begin{array}{l}
      ...
      \qquad\Rightarrow\\
      \qquad\npair[n']{\left(\array{l}\src{(\reg_S\updReg{\pcreg,\rretc,\rretd}{v_S,k_{c,S},k_{d,S}},\ms_S,\stk, \ms_\stk)},\\
                                          (\reg_T\updReg{\pcreg,\rretc,\rretd}{v_T,k_{c,T},k_{d,T}},\ms_T)\endarray\right)}
      \in \lro(W)
    \end{array}
            \right\}
\]
