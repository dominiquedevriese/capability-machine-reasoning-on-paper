...
We define that a word $w$ is reasonable if the following implications hold.
\begin{itemize}
...
For any $\Phi$ such that
  ...
  \item $\Phi.\reg(r)$ is reasonable for all $r \not\in \{\pcreg,\rdata\}$
  \item $\Phi.\mem(a)$ is reasonable for all $a$
  \item $\Phi.\ms_\stk$ is reasonable for all $a$
  \item $\Phi.\ms_\stk|_{\dom(\ms_\stk')} = \ms_\stk'$
  \item $\Phi.\mem$, $\Phi.\ms_\stk$ and $\Phi.\stk$ are all disjoint
  \end{itemize}
  We have the following implications:
  \begin{itemize}
  \item[Guarantee stack base address before call] If
    \begin{itemize}
    \item $\Phi \nstep[i]{\ta,\stkb} \Phi'$
    ...
    \end{itemize}
  \item[Use return seals only for calls] If
    \begin{itemize}
    \item $\Phi \nstep[i]{\ta,\stkb} \Phi'$
    ...
    \end{itemize}
  \item[Don't store private stuff...] If
    \begin{itemize}
    \item $\Phi \nstep[i]{\ta,\stkb} \Phi'$
    \item $\src{\Phi'}$ points to $\src{\tstore{r_1}{r_2}}$ in $\ta$, then 
    \end{itemize}
    Then $\Phi.\reg(r_2)$ is reasonable
  \item[Don't leak private stuff...] If
    \begin{itemize}
    \item $\Phi \nstep[i]{\ta,\stkb} \Phi' \step \Phi''$
    \item $\src{\Phi'}$ is in $\ta$
    \item $\src{\Phi''}$ is not in $\ta$
    \end{itemize}
    Then $\Phi.\reg(r)$ is reasonable for all $r$ (including $\pcreg$)
  \end{itemize}
