...
\[
  \lre(W) = \left\{ \npair{\stpair[.]{v_{c,S},v_{d,S}}{v_{c,T},v_{d,T}}} \middle| 
    \begin{array}{l}
      ...
      \qquad\npair[n']{\stpair{\reg}{\reg}} \in \lrr(\{\rdata\})(W_\lrr) \wedge\\
...
\dominique{18-1-2018: Lau, I suppose the above has been answered verbally already during one of the previous skype calls, but for reference, this is what the spatial vs spatial_owned distinction is intended to solve: the world will contain spatial regions for such memory segments, but not spatial_owned ones, so the memory satisfaction will require the memory to be present but not allow it to be addressed.}
...
%
    ...
    \begin{array}{l}
      ...
      \quad \npair[n']{\stpair{\reg}{\reg}} \in \lrr(\{\rdata,\rtmp{1},\rtmp{2}\})(W_\lrr) \wedge \\
