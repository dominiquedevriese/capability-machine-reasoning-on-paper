...
\begin{align*}
  ...
  \Phi & \step \sem{\decInstr{\Phi.\mem(\aaddr)}}(\Phi) & &\left.\arraycolsep=0pt
                                                  \begin{array}[t]{l}
                                                    \text{if }\Phi(\pcreg) = ((\perm,\_),\baddr,\eaddr,\aaddr) \tand \\
                                                    \neg\callCond{\Phi,r_1,r_2,\aaddr} \tand\\
                                               ...
                                               \begin{cases}
                                                 ...
                                                 \begin{array}[t]{rl}
                                                   &\updReg{r_1}{w_1} \\
                                                        ...
                                                        &\updReg{\rdata}{c_2}\\
                                                        &\updReg{\rstk}{c_\stk}\\
                                                        &\updReg{\rretc}{\retptrc(\sigma_?)}\\
                                                        &\updReg{\rretd}{\retptrd(\sigma_?)}
                                                 \end{array}
                                                 & 
                                                 \arraycolsep=0pt
                                                 \begin{array}[t]{l}
                                                   ...
                                                   \ms_{\stk,\priv} = \ms_\stk |_{[\aaddr_\stk,\eaddr]}\update{\aaddr_\stk}{\eaddr_\stk} \tand\\
...
\[
  \lre(W) = \left\{ \npair{\stpair{v}{v}} \middle| 
    \begin{array}{l}
      \forall n' \leq n, \src{k_{d,S}}, \src{k_{c,S}}, k_{d,T}, k_{c,T}, \src{\reg_S}, \reg_T, \src{\ms_S}, \ms_T, \src{\ms_\stk}, \src{\stk} \ldotp\\
      \quad \exists W_\lrp, W_\lrk, W_\lrr, W_\lrm \text{ that is a separarion of $W$}\ldotp  \wedge \\
      \qquad\npair[n']{\stpair{v}{v}} \in \lrp(W_\lrp) \wedge \\
      ...
      \qquad\Rightarrow\\
      \qquad\npair[n']{\left(\array{l}\src{(\ms_S,\reg_S\updReg{\pcreg,\rretc,\rretd}{v_S,k_{c,S},k_{d,S}},\stk, \ms_\stk)},\\
                                          (\ms_T,\reg_T\updReg{\pcreg,\rretc,\rretd}{v_T,k_{c,T},k_{d,T}})\endarray\right)}
      \in \lro(W)
    \end{array}
            \right\}
\]
...
\[
  \lrk(W) = \left\{ \npair{\left(\array{l}\src{\retptrd(\sigma)},\\\src{\retptrc(\sigma)},\\k_{d,T},k_{c,T}\endarray\right)} \middle|
    \begin{array}{l}
      ...
      \forall n' \leq n, W' \privft W \ldotp \\
      \quad \exists W_\lrk, W_\lrr, W_\lrm \text{ that is a separarion of $W'$}\ldotp  \wedge \\
      \qquad\npair[n']{\stpair{\reg}{\reg}} \in \lrr(W_\lrr) \wedge\\
      \qquad\memSat[n']{\stpair[.]{\ms_S,\stk,\ms_\stk}{\ms_T}}{W_\lrm} \\
      \qquad\Rightarrow\\
...
\[
  ...
  \begin{array}[t]{l}
    ...
    \left\{ \npair{\left(\arraycolsep=0pt\array{l}\src{\retptrc(\sigma)},\\\sealed{\sigma,\vsc_C}\endarray\right)} \middle| 
    \begin{array}{l}
    \forall n'<n, W' \pubft W, \npair[n']{\stpair[.]{\retptrd(\sigma)}{\sealed{\sigma,\vsc_D}}} \in \lrv(W') \ldotp\\
      \npair[n']{\retptrc(\sigma),\retptrd(\sigma),\sealed{\sigma,\vsc_C},\sealed{\sigma,\vsc_D}} \in \lrk(W')
    \end{array}
    \right\}\cup\\
    \left\{ \npair{\left(\arraycolsep=0pt\array{l}\src{\retptrd(\sigma)},\\\sealed{\sigma,\vsc_D}\endarray\right)} \middle| 
    \begin{array}{l}
    \forall n'<n, W' \pubft W, \npair[n']{\stpair[.]{\retptrc(\sigma)}{\sealed{\sigma,\vsc_C}}} \in \lrv(W') \ldotp\\
      \npair[n']{\src{\retptrc(\sigma)},\src{\retptrd(\sigma)},\sealed{\sigma,\vsc_C},\sealed{\sigma,\vsc_D}} \in \lrk(W')
    \end{array}
    \right\}\cup \\
