...
\[
  ...
  \left\{
    \begin{array}{l}
      ...
      \quad \exists R_W : \dom(\activeReg{W_\var{stack}}) \fun \World\ldotp\\
      \qquad W = \oplus_{r \in \activeReg{W_\var{stack}}} R_W(r) \wedge\\
      \qquad \forall r \in \activeReg{W_\var{stack}}, n' < n \ldotp \\
