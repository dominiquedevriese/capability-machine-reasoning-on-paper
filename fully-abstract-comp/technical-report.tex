...
%
    ...
    \begin{array}{l}
      ...
      \quad \npair[n']{\stpair[.]{\vsc_S}{\vsc_T}} \in H_\sigma \; \sigma \; W \text{ for all $n' < n$}\wedge\\
...
\begin{proof}
  ...
  \item $w = \sealed{\sigma,\vsc}$ and
    ...
    \begin{itemize}
    \item $\npair[n']{(\vsc,\vsc)} \in H_\sigma \; \sigma \; W$ for all $n' < n$:
     ...
     this follows
     by induction and Lemma~\ref{lem:non-expansive} (if $\vsc \not\in \overline{c_{\mathrm{import}}}$) or by assumption, we know that $\npair[n']{(\vsc,\vsc)} \in \lrv(W)$.
