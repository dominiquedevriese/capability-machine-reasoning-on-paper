...
\begin{align*}
  ...
  \left\{\begin{aligned}
     &\npair{\var{comp},\var{comp}} \;\mid \;\\
      ...
      &\qquad\quad\text{then } \npair[n']{(\sigrets\uplus\sigcloss,\mscode\uplus \msdata', \mscode\uplus\msdata')} \in \lrheap(\pwheap)(W') \text{ for all $n' < n$} \tand\\
...
\begin{proof}
  ...
  \begin{equation*}
    \npair[n']{(\sigrets[3]\uplus\sigcloss[3],\mscode[3]\uplus \msdata[3]', \mscode[3]\uplus\msdata[3]')} \in \lrheap(\pwheap[(W_1\uplus W_2)])(W')
  \end{equation*}
  for all $n' < n$ and
  \begin{equation*}
  ...
  \begin{align*}
    \npair[n']{(\sigrets[1]\uplus\sigcloss[1],\mscode[1]\uplus \msdata[1]', \mscode[1]\uplus\msdata[1]')} &\in \lrheap(\pwheap[W_1])(W')\\
    \npair[n']{(\sigrets[2]\uplus\sigcloss[2],\mscode[2]\uplus \msdata[2]', \mscode[2]\uplus\msdata[2]')} &\in \lrheap(\pwheap[W_2])(W')
  \end{align*}
  for all $n' < n$.
...
\begin{proof}
  ...
  \item
    \begin{equation*}
      \npair[n']{(\sigrets\uplus\sigcloss,\mspad\uplus\mscode\uplus \msdata', \mspad\uplus\mscode\uplus\msdata')} \in \lrheap(\pwheap)(W')
    \end{equation*}
    for all $n' < n$.
...
\begin{proof}
  ...
  then
  \begin{equation*}
    \npair[n']{(\sigrets\uplus\sigcloss,\mscode\uplus \msdata', \mscode\uplus\msdata')} \in \lrheap(\pwheap)(W')
  \end{equation*}
  for all $n' < n$ and
  \begin{equation*}
    \overline{\npair{(w_{\mathrm{export}},w_{\mathrm{export}})}} \in \lrv(\purePart{W'})
