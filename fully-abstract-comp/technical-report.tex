  ...
  \sem{\scall{\src{r_1}}{\src{r_2}}}(\Phi) = & 
                                               \begin{cases}
                                                 ...
                                                 \begin{array}[t]{l}
                                                   ...
                                                   \ms_{\stk,\var{rest}} = \ms_\stk|_{[\baddr,\aaddr_\stk - 1]} \tand \\
                                                   c_\stk = \stkptr{\baddr,\aaddr_\stk-1,\aaddr_\stk-1} \tand \\
...
\item The base address of the stack capability is a fixed address, so in the semantice, it will be expressed as a constant that is publicly known.
\end{itemize}
