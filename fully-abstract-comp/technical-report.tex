...
\begin{align*}
  \var{comp} &\mathrel{::=} (\ms_{\mathrm{code}},\ms_{\mathrm{data}},\overline{c_{\mathrm{import}}},\overline{c_{\mathrm{export}}},\sigrets,\sigcloss)
\end{align*}
...
\begin{mathpar}
  ...
  \inference{
    ...
    \forall a \in \dom(\msdata)\ldotp \dom(\mscode),\dom(\msdata),A_{\mathrm{own}}(a),\overline{c_{\mathrm{import}}},\sigrets,\sigcloss \vdash_{\mathrm{comp-value}} \msdata(a)\\
