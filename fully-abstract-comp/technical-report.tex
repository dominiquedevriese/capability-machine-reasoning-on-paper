...
\begin{mathpar}
  \inference{
    ...
    \vdash (\mscode,\msdata,\overline{\var{import}},\overline{\var{export}},\sigrets,\sigcloss,A_\linear)
  }
  \and
  \inference{
...
\begin{proof}
  ...
  Take
  \begin{equation*}
    \var{comp} = (\mscode,\msdata,\overline{\var{import}},\overline{\var{export}},\sigrets,\sigcloss,A_\linear)
  \end{equation*}
