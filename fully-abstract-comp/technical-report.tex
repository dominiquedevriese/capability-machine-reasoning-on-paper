...
\begin{mathpar}
  \inference{}{
    A_{\mathrm{code}},A_{\mathrm{data}},\overline{c_{\mathrm{import}}} \vdash_{\mathrm{comp-value}} z
  }
  \and
  \inference{
    c \in \overline{c_{\mathrm{import}}}
  }{
    A_{\mathrm{code}},A_{\mathrm{data}},A_{\mathrm{own}},\overline{c_{\mathrm{import}}} \vdash_{\mathrm{comp-value}} c
  }
  \and
  \inference{
    [\baddr,\eaddr] \subseteq A_{\mathrm{code}} & \perm \sqsubseteq \rx
  }{
    A_{\mathrm{code}},A_{\mathrm{data}},A_{\mathrm{own}},\overline{c_{\mathrm{import}}} \vdash_{\mathrm{comp-value}} ((\perm,\normal),\baddr,\eaddr,\aaddr)
  }
  \and
  \inference{
    ...
    A_{\mathrm{code}},A_{\mathrm{data}},A_{\mathrm{own}},\overline{c_{\mathrm{import}}} \vdash_{\mathrm{comp-value}} ((\perm,\lin),\baddr,\eaddr,\aaddr)
  }
  \and
  \inference{
    ...
    \forall a \in [\baddr_{\mathrm{code}}+1,\eaddr_{\mathrm{code}}]\ldotp \dom(\ms_{\mathrm{code}}),\dom(\ms_{\mathrm{data}}),\emptyset,\overline{c_{\mathrm{import}}} \vdash_{\mathrm{comp-value}}\ms_{\mathrm{code}}(a)\\
    ...
    \forall a \in \dom(\ms_{\mathrm{data}})\ldotp \dom(\ms_{\mathrm{code}}),\dom(\ms_{\mathrm{data}}),A_{\mathrm{own}}(a),\overline{c_{\mathrm{import}}} \vdash_{\mathrm{comp-value}}\ms_{\mathrm{data}}(a)\\
  }{
