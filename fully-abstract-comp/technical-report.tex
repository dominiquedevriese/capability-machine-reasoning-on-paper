...
\[
  \begin{array}{rrcl}
   \addrbnf,\basebnf \in & \Addr & \defeq & \nats \\
    ...
    & & & {\sourcecolor{} \mid \stkptr{\permbnf,\basebnf,\aendbnf,\addrbnf}}\\     &\cbnf & \defbnf &  \scbnf \mid \sealed{\scbnf,\sigma}{\sourcecolor{} \; \mid \retptr}\\ 
...
\[
  \noRetStkReg{\reg} \defeq \forall r \in \reg \setminus \{ \pcreg, \rstk, \rO, \rdata \} \ldotp \reg(r) \neq \stkptr(\_)
\]

\[
  \noRetStkMs{\ms} \defeq \defeq \forall \aaddr \in \dom(\ms) \ldotp \ms(\aaddr) \neq \stkptr(\_)
\]
    ...
    \begin{cases}
      (\mem,\reg',\stk',\ms_\stk') & \arraycolsep=0pt
                                      \begin{array}[t]{l}
                                        ...
                                        \reg' = \reg\update{\pcreg}{\cb_1}\update{\rstk}{\stkptr{\perm,[\aaddr,eaddr],\aaddr}}\update{\rO}{\retptr}\update{\rdata}{\cb_2} \text{ and } \\
