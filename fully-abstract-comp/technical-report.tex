...
%
    ...
    \begin{array}{l}
      ...
      \qquad \dom(\ms) = [\baddr, \eaddr] \wedge \stareg{\spao} \nequal W(r) \wedge \\
      \qquad \forall W' \privft W \ldotp \\
      \qquad \quad \exists r' \ldotp W'(r') = W(r) \wedge \exists r'' \ldotp W'(r'') = \stdreg{[\stkb,\aaddr]}{\spao} \ldotp \\
      \qquad \qquad { \color{red} \forall (c, c') \in H_\sigma (\sigma) \ldotp \npair{\src{c,\retptrd(\sigma,\baddr,\eaddr)}, c' , \sealed{\sigma,\vsc_D}} \in \lrk(W') }%\text{\lau{This needs some work - specifically what i c and c' and do we need to seal them?}}
