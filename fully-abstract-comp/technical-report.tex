...
\begin{definition}[No hidden calls]
  ...
  \]
\end{definition}
\lau{07-07-2018: TODO, consider if the well-formedness judgement should take the trusted addresses into account, so the trusted component specific things only are required for trusted addresses. It already uses $\ta$, so it already ought to be part of the judgement.
}
\lau{07-07-2018: TODO: why don't we permit closure seals in data memory? That seems like an oversight.}
...
\begin{definition}[Initial execution configuration]
  ...
  \end{mathpar}
\end{definition}
\lau{07-07-2018: TODO why don't the above definition case about the stack base?}
...
\lau{09-07-2018: TODO: add $\gc$ to memsat relations.}
\[
...
\lau{09-07-2018: TODO: It seems very odd to me that the return and closure seals in $\gc$ are independent of the seals in the component. I would suspect that in the trusted case, $\gsigrets,\gsigcloss$ is a suberset of the seals in the component (or something like that). }
