...
\begin{align*}
  ...
  \begin{cases}
    ...
    \sourcecolor\left.
      \begin{array}[t]{l}
        c_1 = \retptrc(\_,\_,\baddr,\eaddr,\aaddr) \tand \\
...
\left\{
    \begin{array}{l}
\left. \npair{\arraycolsep=0pt\left(\array{l}\retptrc(\rx,\lin,\baddr,\eaddr,\aaddr'+\calllen),\\((\rx,\lin),\baddr,\eaddr,\aaddr)\endarray\right)} \middle| \right. \\
      \\
      \begin{array}{l}
