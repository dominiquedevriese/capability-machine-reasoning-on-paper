...
\begin{definition}
  A component $\program = (\ms_{\mathrm{code}},\ms_{\mathrm{data}},\overline{c}_{\mathrm{import}},\overline{c}_{\mathrm{export}},\sigrets,\sigcloss)$ with $\dom(\ms_{\mathrm{code}}) = \ta$, is reasonable if for all $n$ and all contexts $\context$ the configuration $\plug{\context}{\program}$ satisfies:
  \begin{itemize}
