...
\begin{theorem}[FTLR]
  ...
  \[
    ...
    \end{array}
  \]
  \dominique{6-3-2018: $\readCond{\lin,W}$ and $\xReadCond{\lin,W}$ seem contradictory.
    I suspect the latter needs to go? I suspect we don't need to assume the context has no way to modify its own code.}
\end{theorem}
