...
\begin{mathpar}
  ...
  \inference{
    \mscode(a) \in \ints\\
    \mscode([a \cdots a + \calllen-1]) = \scall[0..\calllen-1]{\offpc,\offsigma}{r_1}{r_2} \Rightarrow (\mscode(a+\offpc) = \seal{\sigma_\baddr,\sigma_\eaddr,\sigma_\baddr} \wedge \sigma_\baddr+\offsigma \in \sigrets)
  }{
    \sigrets,\sigcloss \vdash_{\mathrm{comp-code}} \mscode,a
  }
  \and
