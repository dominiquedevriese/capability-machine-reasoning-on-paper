...
\begin{definition}[No hidden calls]
  ...
  \]
\end{definition}
\lau{07-07-2018: TODO, consider if the well-formedness judgement should take the trusted addresses into account, so the trusted component specific things only are required for trusted addresses.}
