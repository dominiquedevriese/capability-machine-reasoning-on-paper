...
\begin{align*}
  ...
  \left\{ \npair{(\baddr,\eaddr)} \middle|
    \begin{array}{l}
      \forall n' < n, W' \future \purePart{W}, \aaddr \in [\baddr',\eaddr'] \subseteq [\baddr,\eaddr] \ldotp\\
  ...
  &\cup\left\{ \npair{(\baddr,\eaddr)} \middle|
    \begin{array}{l}
      \lin = \linear \wedge\\
      \exists W_a : [\baddr,\eaddr] \fun \World \wedge W = \oplus_{a\in[\baddr,\eaddr]} W_a(a)\wedge\\
      \forall n' < n, \aaddr\in[\baddr',\eaddr'] \subseteq [\baddr,\eaddr], W' \future \oplus_{a\in[\baddr',\eaddr']} W_a(a), \ldotp\\
      \quad \npair[n']{\stpair[.]{((\rx,\lin),\baddr',\eaddr',\aaddr)}{((\rx,\lin),\baddr',\eaddr',\aaddr)}} \in \lre(W')
    \end{array}
    \right\}
\end{align*}
