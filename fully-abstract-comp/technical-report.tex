...
\begin{align*}
  \var{comp} &\mathrel{::=} (\mscode,\msdata,\overline{c}_{\mathrm{import}},\overline{c}_{\mathrm{export}},\sigrets,\sigcloss)
\end{align*}
...
\begin{equation*}
  H^\mathrm{code} \; \sigrets \; \sigcloss \; \code \; s \; \hat{W} = \left\{\npair{(\code,\code)} \middle|
...
\begin{multline*}
  H^\mathrm{code}_\sigma \; \sigrets \; \sigcloss \; \code \; s \; \sigma \; \hat{W} = \\
  \begin{array}[t]{l}
\left\{
    \begin{array}{l}
...
\begin{definition}[World specifies component]
  ...
  \begin{equation*}
    \var{comp} = (\mscode,\msdata,\overline{c}_{\mathrm{import}},\overline{c}_{\mathrm{export}},\sigrets,\sigcloss)
  \end{equation*}
  (written as $W \vdash \var{comp}$)
  iff there exist $r_1 \cdots r_n \in \dom(\pwheap)$ such that
  \begin{itemize}
