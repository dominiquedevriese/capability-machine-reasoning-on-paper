...
\[
  \xReadCond{\lin,W} = \left\{ \npair{(\baddr,\eaddr})) \middle| 
    \begin{array}{l}
      ...
      \quad \npair{(\ms,\ms)} \in H^{\mathrm{std}}_{\dom(\ms)} \; * \; W \wedge \\
...
\begin{theorem}[FTLR]
  ...
  \[
    ...
    \end{array}
  \]
  \dominique{6-3-2018: I removed $\readCond{\lin,W}$ and replaced it with $\xReadCond{\lin,W}$ since we are assuming there are no rwx pointers anywhere.}
\end{theorem}
