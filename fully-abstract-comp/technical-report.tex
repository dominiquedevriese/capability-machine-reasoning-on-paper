...
\begin{figure}[!h]
  ...
  \begin{tikzpicture}[main node/.style={}]
    ...
    \node[main node] (rwxo) [below right of=rwx,yshift=-0.1cm] {$\rwxo$};
    ...
    \node[main node] (rwo) [below right of=rw,yshift=-0.1cm] {$\rwo$};
...
Note that it would be good if malloc provided a way to initially obtain a linear capability in this model.
