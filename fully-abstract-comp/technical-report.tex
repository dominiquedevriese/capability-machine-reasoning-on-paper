...
\[
  ...
  \end{array}
\]
\lau{Should seals also have the option to be linear?}
...
\trg{i} &\defbnf & \tfail \mid \thalt \mid \tjmp{\trg{r}} \mid \tjnz{\trg{r}}{\trg{\rn}} \mid \tisptr{\trg{r}}{\trg{r}} \mid \tgeta{\trg{r}}{\trg{r}} \mid \tgetb{\trg{r}}{\trg{r}} \mid \\
      & &  \tgete{\trg{r}}{\trg{r}}\mid \tgetp{\trg{r}}{\trg{r}} \mid \tgetloc{\trg{r}}{\trg{r}} \mid \tgetlin{\trg{r}}{\trg{r}} \mid \tmove{\trg{r}}{\trg{\rn}} \mid \tstore{\trg{r}}{\trg{r}} \mid\\
...
\lau{Notice, the opacity do not hide ``semantic properties'' such as permission, locality and linearity (this could be changed if it is an issue)}
...
\textbf{gettype}\\
\lau{I changed \textbf{isptr} to an instruction that can tell what kind of word is located in a register (as we now have more kinds than integers and capabilities).}
...
\lau{TODO: Write out what $\encType{}$ should satisfy}
\begin{align*}
  \tsem{\sisptr{r_1}{r_2}} = & 
                               \begin{cases}
...
\textbf{move}\\
\lau{Like previously, the order of updates in the second case matters for the case where $r_1 = r_2$.}
\begin{align*}
  \tsem{\tmove{r_1}{r_2}} = & 
                              \begin{cases}
