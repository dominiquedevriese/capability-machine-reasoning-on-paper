...
\begin{align*}
  (i,\normalReg,\var{sm}) \uplus (j,\normalReg,\var{sm}) =  & \; (\max(i,j),\normalReg,\var{sm}) \\
  (1,\pureReg,\var{sm}) \uplus (0,\pureReg,\var{sm}) =      & \; (1,\pureReg,\var{sm}) \\
  (0,\pureReg,\var{sm}) \uplus (1,\pureReg,\var{sm}) =      & \; (1,\pureReg,\var{sm}) \\
  (0,\pureReg,\var{sm}) \uplus (0,\pureReg,\var{sm}) =      & \; (0,\pureReg,\var{sm}) \\
\end{align*}
and for all other cases $\oplus$ is undefined. Specifically, $\uplus$ is not defined when both sides are an owned $\pureReg$-region. It is further not defined if the two sides do not agree on region type and state machine.
