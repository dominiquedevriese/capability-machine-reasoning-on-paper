...
\[
  \begin{array}{rrcl}
   \addrbnf,\basebnf \in & \Addr & \defeq & \nats \\
    ...
    &\cbnf & \defbnf &  \scbnf \mid \sealed{\scbnf,\sigma}{\sourcecolor{} \; \mid \retptrd(\sigma,(\permbnf,\basebnf,\aendbnf,\addrbnf)) \mid \retptrc(\sigma,(\permbnf,\linbnf,\basebnf,\aendbnf,\addrbnf))}\\ 
...
\[
  \lrk(W) = \left\{ \npair{\left(\array{l}\src{\retptrd(\sigma)},\\\src{\retptrc(\sigma)},\\k_{d,T},k_{c,T}\endarray\right)} \middle|
    \begin{array}{l}
      ...
      \qquad\npair[n']{\src{\retptrd(\sigma)},\src{\retptrc(\sigma)},k_{d,T},k_{c,T}} \in \lrp(W') \wedge \\
      \qquad\npair[n']{\stpair{\reg}{\reg}} \in \lrr(W_\lrr) \wedge\\
      \qquad\memSat[n']{\stpair[.]{\ms_S,\stk,\ms_\stk}{\ms_T}}{W_\lrm} \\
      \qquad\Rightarrow\\
