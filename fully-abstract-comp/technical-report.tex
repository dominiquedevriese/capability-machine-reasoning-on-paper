...
\[
  \lre(W) = \left\{ \npair{\stpair{v}{v}} \middle| 
    \begin{array}{l}
      ...
      \quad \forall \npair[n']{\stpair[.]{(k_{d,S},k_{c,S})}{(k_{d,T},k_{c,T})}} \in \lrk(W) \ldotp \\
      \qquad \forall \stpair{\reg}{\reg}\ldotp \npair[n']{
      \left(\array{l}\src{\reg_S\updReg{\pcreg,\rretd,\rretc}{v_S,k_{d,S},k_{c,S}}},\\\reg_T\updReg{\pcreg,\rretd,\rretc}{v_T,k_{d,T},k_{c,T}}\endarray\right)} \in \lrr(W) \Rightarrow\\
      \qquad \quad \forall \src{\ms_S},\ms_T \ldotp \memSat[n']{\stpair[.]{\ms}{\ms}}{\stpair{\reg}{\reg}}{W} \Rightarrow \\
