...
%
    ...
    \begin{array}{l}
      ...
      \stpair[.]{c_S}{\vsc_T} \in H_\sigma \; s \; \sigma \; W\wedge \\
      \forall W' \future W, W_o, n' < n, \stpair[.]{c_S'}{\vsc'_T} \in H_\sigma \; s \; \sigma \; W_o \ldotp \\
      \quad \npair[n']{\src{c_S},\src{c_S'},\sealed{\sigma,\vsc_T},\sealed{\sigma,\vsc_T'}} \in \lrexj(W'\oplus W_o)
      % 20-3-2018: I expect the next case (commented out below) is never used and hence unneeded.
      % \wedge \\
      % \quad \npair[n']{\src{c_S'},\src{c_S},\sealed{\sigma,\vsc_T'},\sealed{\sigma,\vsc_T}} \in \lrexj(W' \oplus W_o)
    \end{array}
    \right\}\cup\\
...
\left\{
    \begin{array}{l}
\left. \npair{\arraycolsep=0pt\left(\array{l}\retptrc(\sigma,((\rx,\lin),\baddr,\eaddr,\aaddr'+\calllen - 1)),\\((\rx,\lin),\baddr,\eaddr,\aaddr)\endarray\right)} \middle| \right. \\
      \\
      \begin{array}{l}
...
\left\{
    \begin{array}{l}
\left. \npair{\arraycolsep=0pt\left(\array{l}\retptrd(\sigma,(\baddr,\eaddr)),\\((\rx,\linear),\baddr,\eaddr,\aaddr)\endarray\right)} \middle| \right. \\
      \\
      \begin{array}{l}
