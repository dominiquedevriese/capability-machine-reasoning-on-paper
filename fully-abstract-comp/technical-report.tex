...
\begin{mathpar}
  \inference{
    ...
    A_{\mathrm{code}},A_{\mathrm{non-linear}},\sigrets,\sigcloss \vdash_{\mathrm{comp-export}} \sealed{\sigma,((\rx,\normal),\baddr,\eaddr,\aaddr)}
  }
  \and
  \inference{
    A_{\mathrm{code}},\emptyset,A_{\mathrm{non-linear}},\emptyset,\sigrets,\sigcloss \vdash_{\mathrm{comp-value}} w
  }{
    A_{\mathrm{code}},A_{\mathrm{non-linear}},\sigrets,\sigcloss \vdash_{\mathrm{comp-export}} w
  }
\end{mathpar}
...
\begin{multline*}
  ...
  \left\{\npair{(\code,\code)} \middle|
    ...
    \dom(\code) = [\aaddr,\baddr] \wedge \\
      (\dom(\code) \subseteq \ta \wedge \sigrets \subseteq \gsigrets \wedge \trust = \trusted) \vee \\
