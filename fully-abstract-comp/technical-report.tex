...
%
    ...
    \begin{array}{l}
      ...
      \quad \npair[n']{\stpair{\reg}{\reg}} \in \lrr(\{\rdata,\rstk,\rtmp{1},\rtmp{2}\})(W_\lrr) \wedge \\
      ...
      \qquad \Rightarrow \\
      \qquad \quad \npair[n']{\left(\array{l}(\ms_S,\reg_S\updReg{\rstk,\pcreg,\rdata,\rtmp{1},\rtmp{2}}{\stkptr{\rw,\stkb,\eaddr,\baddr},((\perm_C,\lin_C),\baddr_C,\eaddr_C,\aaddr_C),0,0,0},\stk,\ms_\stk \uplus \ms_f),\\
                                             (\ms_T,\reg_S\updReg{\rstk,\pcreg,\rdata,\rtmp{1},\rtmp{2}}{((\rw,\linear),\stkb,\eaddr,\baddr),((\perm_C,\lin_C),\baddr_C,\eaddr_C,\aaddr_C+?)})
