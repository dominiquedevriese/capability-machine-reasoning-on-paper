...
&
                               ...
                               \end{cases}
\end{align*}
\lau{(important) TODO 05-07-2018: It seems that there may be an issue related to splicing stk-ptr with a linear capability.
  This would be okay on trg machine, but fail on src machine.
  It may possibly be fixed simply by padding the stack with un-addressable memory (like we did with code memory).}
