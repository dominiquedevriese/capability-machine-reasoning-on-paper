...
\[
  \codereg{\ta,\overline{\sigma_{\mathrm{ret}}},\overline{\sigma_{\mathrm{clos}}},\code} \defeq (\pure,*,=,=,H^\mathrm{code} \; \ta \; \overline{\sigma_{\mathrm{ret}}} \; \overline{\sigma_{\mathrm{clos}}} \; \code,H^\mathrm{code}_\sigma \; \ta \; \overline{\sigma_{\mathrm{ret}}} \; \overline{\sigma_{\mathrm{clos}}} \; \code)
\]

\[
  H^\mathrm{code} \; \ta \; \overline{\sigma_{\mathrm{ret}}} \; \overline{\sigma_{\mathrm{clos}}} \; \code \; s \; \hat{W} = \left\{
    \npair{(\code,\code)} \mid
  \begin{multlined}
    \dom(\code) = [\aaddr,\baddr] \tand (\overline{\sigma_{\mathrm{ret}}} \cup \overline{\sigma_{\mathrm{clos}}}) = [\sigma_\baddr,\sigma_\eaddr] \tand \\
...
\[
  H^\mathrm{code}_\sigma \; \ta \; \overline{\sigma_{\mathrm{ret}}} \; \overline{\sigma_{\mathrm{clos}}} \; \code \; s \; \sigma \; \hat{W} = 
  \begin{array}[t]{l}
\left\{
    \begin{array}{l}
\left. \npair{\arraycolsep=0pt\left(\array{l}\retptrc(\rx,\lin,\baddr,\eaddr,\aaddr'+\calllen - 1),\\((\rx,\lin),\baddr,\eaddr,\aaddr)\endarray\right)} \middle| \right. \\
      ...
      \begin{array}{l}
        ...
        \sigma = \sigma_\baddr + o \in \overline{\sigma_{\mathrm{ret}}}\tand\\
...
\left. \npair{\arraycolsep=0pt\left(\array{l}\retptrd(\baddr,\eaddr),\\((\rw,\linear),\baddr,\eaddr,\aaddr)\endarray\right)} \middle| \right. \\
      ...
      \begin{array}{l}
        ...
        \quad \sigma = \sigma_\baddr + o \in \overline{\sigma_{\mathrm{ret}}}\tand\\
        \quad a = b-1\tand \\
...
\left. \npair{(\vsc, \vsc' )} \middle| \right. \\
      \begin{array}{l}
        \sigma \in \overline{\sigma_{\mathrm{clos}}} \tand\\
