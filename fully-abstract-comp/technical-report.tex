...
\begin{proof}
  ...
  \item $\trust = \untrusted$ and $\dom(\mscode \mathrel{\#} \ta)$:
    ...
    The first requirement follows from Lemma~\ref{lem:code-memory-untrusted-readable}.
    The second follows from the definition of $\xReadCond$, together with the assumption that $\pwheap(r_{\mathrm{code}}) = \codereg{\sigrets,\sigcloss,\mscode,\gc}$.
    The third TODO \dominique{TODO: assume induction hypo of FTLR?}
