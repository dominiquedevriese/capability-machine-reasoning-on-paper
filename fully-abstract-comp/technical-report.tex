...
\begin{align*}
  ...
  \left\{\begin{multlined}
     \npair{\var{comp},\var{comp}} \;\mid \;\\
      ...
      \forall W' \ldotp \text{If } W \oplus W' \text{ is defined }\\
      \tand \overline{\npair{(c_{\mathrm{import}},c_{\mathrm{import}})}} \in \lrv(W')\\
      \text{then } \overline{\npair{(c_{\mathrm{export}},c_{\mathrm{export}})}} \in \lrv(W)
  \end{multlined}
    \right\}\\
  &\cup \left\{\begin{multlined}
