...
\[
  \lrk(W) = \left\{ \npair{\left(\array{l}\src{\retptrd(\sigma,(\aaddr_d,\eaddr_d))},\\\src{\retptrc(\sigma,(\perm,\lin,\baddr_c,\eaddr_c,\aaddr_c))},\\k_{d,T},k_{c,T}\endarray\right)} \middle|
    \begin{array}{l}
      ...
      \qquad\Rightarrow\\
      \qquad\npair[n']{\left(\array{l}\src{\left(\arraycolsep=0pt\array{l}\ms_S,\reg_S\updReg{\pcreg,\rstk}{\opc,\stkptr{\rw,\baddr_\stk,\eaddr_d,\aaddr}},\\\stk, \ms_\stk \uplus \ms_{\stk,f}\endarray\right)},\\
                                          (\ms_T,\reg_T\updReg{\pcreg,\rstk}{\opc,((\rw,\lin),\baddr_\stk,\eaddr_d,\aaddr)})\endarray\right)}
