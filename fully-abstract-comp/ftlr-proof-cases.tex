...
\item If $\trust =\trusted$ then $ \Phi_S$ is reasonable up to $n'$ steps.
  ...
  \item $\pwheap[W_w](r_\code) \nequal \codereg{\sigrets,\sigcloss,\code,\gc}$: TODO
  \item $\dom(\code) \subseteq \ta$: Follows from $\trust = \trusted$ by the choice of $\trust$.
  \item $\sigrets \subseteq \gsigrets$ and $\sigcloss \subseteq \gsigcloss$: TODO
  \end{itemize}
