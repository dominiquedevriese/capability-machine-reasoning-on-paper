  ...
  \item \label{case:ftlr:jump} All of the following hold: (includes control-flow manipulation cases:
    ...
    \item One of the following holds
      ...
      \item(xjmp) $\Phi_S(r_1) = \sealed{\sigma,c_1}$ and $\Phi_S(r_2) =
        ...
        $\Phi_T(r_2) = \sealed{\sigma,c_2'}$ and
        $c_1' \neq \retptrc(\_)$ and $c_2' \neq \retptrd(\_)$ and
        $\nonExec{\Phi_S(r_2)}$ and $\nonExec{\Phi_T(r_2)}$ and
        $\Phi_S'' = \Phi_S\updReg{r_1,r_2}{\linCons{c_1},\linCons{c_2}}$ and $\Phi_S' = \xjumpResult{c_1}{c_2}{\Phi_S''}$ and
        $\Phi_T'' = \Phi_T\updReg{r_1,r_2}{\linCons{c_1'},\linCons{c_2'}}$ and
        $\Phi_T' = \xjumpResult{c_1'}{c_2'}{\Phi_T''}$
      \end{enumproof}
    \end{itemize}
  \end{enumproof}
    ...
    \item $\reg_S^{(3)}(\rstk) = \stkptr{\perm_\var{ret\_\stk},\baddr_\var{ret\_\stk},\eaddr_\var{ret\_\stk},\_}$ and $\baddr_\var{ret\_\stk} = \stkb$ and $\eaddr_\var{ret\_\stk} +1 = \baddr_\stk' $ and $\perm_\var{ret\_\stk} = \rw$ and $\baddr_\var{ret\_\stk} \leq \eaddr_\var{ret\_\stk}$.
      ...
      \item
        ...
        \item $\memSatFStack[n''']{\ms^{(3)}_\stk \uplus \ms_{\priv,S}^{(3)},\ms_\var{T,free\_stack} \uplus \ms_\var{T,stack} | _{\dom(\ms_{\priv,S}^{(3)})}}{W_{\var{free\_stack}}'''}$
          ...
          From the $\memSatFStack[n''']{\ms^{(3)}_\stk,\ms_\var{T,free\_stack}}{W_{\var{free\_stack}}''}$ assumption we get $R_\ms : \dom(\activeReg{W_{\var{free\_stack}}''}) \fun \MemSeg \times \MemSeg$ and $R_W : \dom(\activeReg{W_{\var{free\_stack}}''}.\free) \fun \Worlds$ for which
          \begin{itemize}
    ...
    \item $\ta \# [\baddr,\eaddr]$: by assumption this entails $\trust = \untrusted$.
      ...
      \item $(\isLinear{\vsc_S} \Rightarrow \forall W' \future R_R(r_1), W_o, n' < n-1, \npair[n']{(\vsc_S',\vsc'_T)} \in H_\sigma \; \sigma \; \xi^{-1}(W_o) \ldotp \npair[n']{\vsc_S,\vsc_S',\vsc_T,\vsc_T'} \in \lrexj(W'\oplus W_o))$
        ...
        \item $\nonExec{\vsc_S'}$:
          ...
          to show $\npair{\Phi_S',\Phi_T'} \in \lro$.
        \end{itemize}
      \item $(\nonLinear{\src{\vsc_S}} \Rightarrow \forall W' \future \purePart{R_R(r_2)}, W_o, n' < n-1, \npair[n']{(\vsc_S',\vsc'_T)} \in H_\sigma \; \sigma \; \xi^{-1}(W_o) \npair[n']{\vsc_S,\vsc_S',\vsc_T,\vsc_T'} \in \lrexj(W'\oplus W_o))$
    ...
    \item $\ta \subseteq [\baddr,\eaddr]$: by assumption this entails $\trust = \trusted$.
      ...
      \item
        ...
        \item $\nonExec{\vsc_S'}$:
          ...
          \[
            \npair[n-1]{((\ms_S,\reg_S\update{\pcreg}{\Phi_S(r_1)}\update{\rdata}{\vsc_S'},\stk,\ms_\stk),(\ms_T,\reg_T\update{\pcreg}{\Phi_T(r_1)}\update{\rdata}{\vsc_T'}))} \in \lro
          \]
