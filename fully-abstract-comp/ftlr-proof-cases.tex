...
\]
This is possible by using the initial assumptions along with Lemma \ref{lem:check-stack-addr-before-call-dc}, \ref{lem:use-return-seals-call-dc}, \ref{lem:handle-trusted-seals-prop-dc}, \ref{lem:never-store-seal-code-cap-dc}, and \ref{lem:downwards-closed}.
