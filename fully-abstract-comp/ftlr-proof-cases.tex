...
\item \[\Phi_S' = \updPcAddr{\Phi\update{\mem.a}{w_2}\updReg{r_1}{w}}\]
  ...
  $\perm \in \readAllowed{}$, $\withinBounds{\Phi(r_2)}$, $w = \Phi.\mem(a)$ and $w_2 = \linCons{w}$
\item \[\Phi_S' = \updPcAddr{\Phi \update{\ms_\stk.a}{w_2}\updReg{r_1}{w}}\]
  with $\Phi(r_2) = \stkptr{\perm,\baddr,\eaddr,\aaddr}$, $\perm \in \readAllowed{}$, $\withinBounds{\Phi(r_2)}$, $\aaddr \in \dom(\Phi.\ms_\stk)$, $w = \Phi.\ms_\stk(a)$ and $w_2 = \linCons{w}$
\end{itemize}
