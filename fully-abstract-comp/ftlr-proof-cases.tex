...
\begin{lemma}[purePart is idempotent]
  For all $W$, $\mathit{purePart}( \purePart{W} ) = \purePart{W}$ and $\purePart{W} = \purePart{W} \oplus \purePart{W}$.
...
\item All of the following hold: (includes cap-manipulation cases: move, cca, restrict, seta2b, cseal, split, splice, that can be handled mostly uniformly)
  ...
  \item One of the following holds:
    ...
    \item (cca,seta2b) $w_1 = \seal{\sigma_\baddr,\sigma_\eaddr,\sigma'}$, $w_1' = \seal{\sigma_\baddr,\sigma_\eaddr,\sigma'}$, $\Phi_S(r_1) = \seal{\sigma_\baddr,\sigma_\eaddr,\sigma'}$ and $\Phi_T(r_1) = \seal{\sigma_\baddr,\sigma_\eaddr,\sigma'}$, $k = 1$
