...
\begin{proof}
  ...
  \item \label{case:ftlr:move-cca-etc} All of the following hold: (includes cap-manipulation cases: move, cca,
    ...
    \item One of the following holds:
      ...
      \item \label{case:ftlr:move-cca-etc:cseal}(cseal) $w_1 = \sealed{\sigma,\Phi_S(r_1)}$, $w_1' = \sealed{\sigma,\Phi_T(r_1)}$, $\Phi_S(r_2) = \Phi_T(r_2) = \seal{\sigma_\baddr,\sigma_\eaddr,\sigma}$, $\sigma_\baddr \le \sigma \le \sigma_\eaddr$, and $k=1$, and either $\Phi_S$ points to $\src{\tcseal{r_1}{r_2}}$ in $\ta$ or $\ta \# [\baddr,\eaddr]$.
      ...
      \item \label{case:ftlr:move-cca-etc:split-stack} (split) $\Phi_S(r_3) = \stkptr{\perm,\baddr,\eaddr,\aaddr}$,
        $\Phi_T(r_3) = ((\perm,\linear),\baddr,\eaddr,\aaddr)$, $\baddr \leq s$,
        $s < \eaddr$, $w_1 = \stkptr{\perm,\baddr,n,\aaddr}$, $w_1' =
        ((\perm,\linear),\baddr,s,\aaddr)$, $w_2 =
        \stkptr{\perm,s+1,\eaddr,\aaddr}$, 

        $w_2' = ((\perm,\linear),s+1,\eaddr,\aaddr)$, $k=2$.
      ...
      \item \label{case:ftlr:move-cca-etc:jnz-z} (jnz zero case) $k = 0$
      \end{enumproof}
    \end{itemize}
