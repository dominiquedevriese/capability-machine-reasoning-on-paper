...
Infinity is a possible end address because we want to be able to have a capability for all of the memory. It is also a word, so it is possible to have the end address of such a capability in memory and compare it to other values.
  ...
  \sem{\minus{\refreg{r_1}}{\rv_1}{\rv_2}}(\Phi)               & =
                                                          \begin{cases}
                                                            ...
                                                            \begin{array}[t]{l}
                                                              \text{if for $i \in \{1,2\}$}\\
                                                              \quad\text{$n_i = \rv_i$ or $n_i = \memreg(\rv_i)$}\\
                                                              \quad\text{and in either case $n_i = \infty$}
                                                            \end{array}\\
                                                            \failed & \text{otherwise}
                                                          \end{cases}\\
  \sem{\lt{\refreg{r_1}}{\rv_1}{\rv_2}}(\Phi)               & =
                                                          \begin{cases}
                                                            ...
                                                            \begin{array}[t]{l}
                                                              \text{if for $i \in \{1,2\}$}\\
                                                              \quad\text{$n_i = \rv_i$ or $n_i = \memreg(\rv_i)$}\\
                                                              \quad\text{and in either case $n_1 \in \ints$ and $n_2 \in \ints \union \{\infty\}$}\\
