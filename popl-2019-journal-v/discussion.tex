...
\begin{jversion}
  ...
  If we were to use a single return seal for multiple call-site, that would allow an adversary to combine a valid return data capability with a return code capability for the wrong call-site, thus breaking WBCF guarantees.
  ...
  Although this approach works, it has the side effect of disallowing any form of dynamic code generation.
