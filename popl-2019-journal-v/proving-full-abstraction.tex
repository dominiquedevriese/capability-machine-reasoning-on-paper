...
\begin{definition}[$\blater$ preordered c.o.f.e.]
  ...
  \[
    ...
    \right.
  \]
  \dominique{I suspect the above definition is wrong and should say}
  \[
...
\dominique{products?}
\dominique{I wonder if it's necessary to show all these constructions in full detail?}
...
\begin{definition}[Shared region preordered c.o.f.e.\ ]
  ...
  \end{itemize}
\end{definition}
Definitions~\ref{def:pure-reg-p-cofe} and~\ref{def:shared-reg-p-cofe} define the preordered c.o.f.e.'s necessary for the regions in our worlds.
