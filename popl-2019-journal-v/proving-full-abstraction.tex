...
In Paragraph~\ref{par:perm-cond} and Paragraph~\ref{par:standard-regions} we present the auxiliary definitions.
In Paragraph~\ref{par:untrusted-val-rel} and Paragraph~\ref{par:trusted-val-rel}, we present the untrusted and trusted value relation, respectively.
