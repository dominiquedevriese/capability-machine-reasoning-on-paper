...
\begin{lemma}[$\blater$ c.o.f.e.]
  ...
  \todo[inline]{replace with actual definition for c.o.f.e (not preoreded!)}.
...
\begin{definition}[$\blater$ preordered c.o.f.e.]
  ...
  \todo[inline]{replace with actual definition for preordered c.o.f.e}.
...
\end{multline*}
and
\todo[inline]{look over relations and make it uniform whether it is $\MemSeg\times\MemSeg$ or $\MemSeg^2$}
\[
  \Regions = \left\{
  \begin{array}{l}
