...
\text{for } (x,y),(x',y') \in X \times Y, \quad    (x,y) \nequal (x',y') \text{ iff } x \nequal_X x' \wedge y \nequal_Y y'
  \]
\end{definition}
\begin{definition}[Sum preordered c.o.f.e.]
...
To this end, we combine the shared region preordered c.o.f.e.\ (Definition~\ref{def:pure-reg-p-cofe}) with the shared region preordered c.o.f.e.\ (Definition~\ref{def:shared-reg-p-cofe}) using the sum preordered c.o.f.e.\ construction in Definition~\ref{def:sum-p-cofe}.
