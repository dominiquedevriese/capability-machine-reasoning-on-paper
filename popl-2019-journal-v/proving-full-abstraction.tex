...
\left. \npair{(\vsc, \vsc' )} \middle| \right. \\
      \begin{array}{l}
        (\dom(\code) \mathrel{\#} \ta \tand \npair{(\vsc,\vsc')} \in \lrv \; \xi(\hat{W})) \vee\\
...
\begin{align*}
  ...
  \left\{\begin{aligned}
     &\npair{\var{comp},\var{comp}} \;\mid \;\\
      ...
      &\qquad\quad\text{then } \npair{(\sigrets\uplus\sigcloss,\mscode\uplus \msdata', \mscode\uplus\msdata')} \in \lrheap(\pwheap)(W') \text{ and }\\
  ...
  &\cup \left\{
    \begin{multlined}
     ...
     \npair{(\var{comp}_0,\var{comp}_0)} \in \lrcomp(W) \text{ and}\\
